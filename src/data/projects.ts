...
export const projects: Project[] = [
  {
    ...
    longDescription: 'Rebuilt my entire portfolio from the ground up with Next.js 15, App Router, TypeScript, and Tailwind CSS. Added dark mode, Framer Motion animations, and file-based blog system. Deleted 3 directories of legacy code and started fresh.',
    tags: ['Next.js 15', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'Markdown Blog'],
